...
def write_to_excel(usn, name, ia1, ia2, ia3, ia4, ia5, ia6, ia7, ia8, ea1, ea2, ea3, ea4, ea5, ea6, ea7, ea8, total1, total2, total3, total4, total5, total6, total7, total8, r1, r2, r3, r4, r5, r6, r7, r8):
    ...
    worksheet.merge_range('C1:F1', 'MANAGEMENT AND ENTREPRENEURSHIP FOR IT INDUSTRY', merge_format)
    worksheet.merge_range('G1:J1', 'COMPUTER NETWORKS', merge_format)
    worksheet.merge_range('K1:N1', 'Elective 1', merge_format)
    worksheet.merge_range('O1:R1', 'DATABASE MANAGEMENT SYSTEM', merge_format)
    worksheet.merge_range('S1:V1', 'Elective 2', merge_format)
    worksheet.merge_range('W1:Z1', 'AUTOMATA THEORY AND COMPUTABILITY', merge_format)
    worksheet.merge_range('AA1:AD1', 'COMPUTER NETWORK LAB', merge_format)
    worksheet.merge_range('AE1:AH1', 'DBMS LABORATORY WITH MIN PROJECT', merge_format)
    j = 2
    for i in range(0, 8):
